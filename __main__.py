...
buttons = [
    [
                        InlineKeyboardButton(
                             text="➕️ Add Hori To Your Chat ➕️",
                             url="https://t.me/HORIMIYA_ROBOT?startgroup=true"),
                    ],
                   [
                       InlineKeyboardButton(
                             text="OFF-Topic",
                             url="https://t.me/Myanimemania"),
                       InlineKeyboardButton(
                             text="About Hori",
...
ABOUT2 = """
*‣ Hori Support Chats*\nJoin My Support Group/Channel For Reporting Problems And Updates On @Hori_Support.
"""

REPO_TXT = """
*‣ Owner:*
• [Demon](t.me/fishi_eyes)
\n*‣ Note:*
• If You Want This Bot's Repo You Can Get It From The Button Below.
• Report Any Kind Of Bugs At [Support](Hori_Support)
"""

ABOUT3 = """Hello [{}], My name is *𝓗𝓸𝓻𝓲-𝓢𝓪𝓷*. A Powerful Telegram Group Management Bot built to help you manage Group easily.
...
Asuka_IMG = (
      "https://telegra.ph/file/9335d84e62b2feda76cb4.jpg",
)
...
Asuka_PIC = "https://telegra.ph/file/9335d84e62b2feda76cb4.jpg"

Asuka_VID = "https://telegra.ph/file/c81811b49965b95f68bec.mp4"

PM_PHOTO = "https://telegra.ph/file/9335d84e62b2feda76cb4.jpg"

Asuka_DISPACHER_PIC = "https://telegra.ph/file/97209deaff6b08c9d368d.jpg"
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_video(
                video="https://telegra.ph/file/c81811b49965b95f68bec.mp4",
                caption="Yes sir, I Am Alive And Working Fine. \nCheck Out The Buttons Mentioned Below to know about me.",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                  [
        ...
        if mod_match:
            ...
            help_buttons.append(
                [
                    ...
                    InlineKeyboardButton(text='Support', url='https://t.me/Hori_Support')
                ]
                    )
    ...
    if query.data == "about_":
        ...
        query.message.edit_caption(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Support", url="t.me/Hori_Support"),
                    InlineKeyboardButton(text="Updates", url="t.me/Hori_Updates"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="akeno_")
                 ],
    ...
    if query.data == "repo_":
        query.message.edit_caption(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Source Code", url="https://t.me/repo_lelo"),
                    InlineKeyboardButton(text="Demon", url="t.me/fishi_eyes"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="akeno_")
                 ],
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    ...
                    InlineKeyboardButton(text="Developer", url="t.me/Fishi_eyes"),
                 ],
                 [
    ...
    if update.effective_chat.type != update.effective_chat.PRIVATE:
        ...
        update.effective_message.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  [
                  InlineKeyboardButton(text=" Click here", url="https://t.me/HORIMIYA_ROBOT?start=help")
                  ]
                ]
            ),
        )
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1921409212 and DONATION_LINK:
            update.effective_message.reply_text(
                "You can also donate to the person currently running me "
                "[ʏᴜᴋɪʜɪʀᴀ ꜱᴏᴍᴀ]({t.me/official_yukihira_soma})".format(DONATION_LINK),
                parse_mode=ParseMode.MARKDOWN)
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            ...
            LOGGER.warning(
                "Hori can't able to send message to support_chat, go and check!")
    ...
    about_callback_handler = CallbackQueryHandler(akeno_callback_data, pattern=r"akeno_")
    akeno_callback_handler = CallbackQueryHandler(about_callback_data, pattern=r"about_")
    ...
    dispatcher.add_handler(akeno_callback_handler)
    ...
    if WEBHOOK:
        ...
        LOGGER.info("Finally 𝓗𝓸𝓻𝓲-𝓢𝓪𝓷 Is Online")
